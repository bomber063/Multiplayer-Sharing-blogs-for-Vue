...
<p>CSS 网格布局(Grid Layout) 是CSS中最强大的布局系统。 这是一个二维系统，这意味着它可以同时处理列和行，不像 <a href="//css-tricks.com/snippets/css/a-guide-to-flexbox/" target="_blank">flexbox</a> 那样主要是一维系统。 你可以通过将CSS规则应用于父元素（成为网格容器）和该元素的子元素（网格元素），来使用网格布局。</p>
<blockquote>
<p><a href="//css-tricks.com/snippets/css/complete-guide-grid/" target="_blank">本文</a>出自于 <a href="http://chris.house/blog/a-complete-guide-css-grid-layout/" target="_blank">Chris House</a> 的个人博客，由<a href="//jirengu.com" target="_blank">饥人谷</a> <a href="//www.zhihu.com/people/jirengu-ruo-yu" target="_blank">若愚老师</a>翻译</p>
</blockquote>
<h2 id="引言">引言</h2>
...
<p>有两个东西，启发我写这篇指南。 第一个是雷切尔·安德鲁（Rachel Andrew）的书<a href="http://abookapart.com/products/get-ready-for-css-grid-layout" target="_blank">为CSS Grid布局准备</a>。 这本书对网格布局做了彻底、清晰的介绍，也是是整篇文章的基础，我强烈建议你购买并阅读他的书。 我的另一个重要灵感是Chris Coyier的<a href="//css-tricks.com/snippets/css/a-guide-to-flexbox/" target="_blank">Flexbox完全指南</a>，当需要查阅 flexbox 的一切资料时我就会找这篇文章。 这篇文章帮助了很多人学习 Flex 布局，也是 Google 上搜索“flexbox”关键字排名第一的文章。你会发现他的文章和我的很多相似之处，有最好的范例在那放着为什么咱不偷师学着写呢？</p>
...
<p><img src="//cloud.hunger-valley.com/18-1-11/55281623.jpg" alt=""></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-11/1314820.jpg" alt=""></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-11/45883436.jpg" alt=""></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-11/406531.jpg" alt=""></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-11/81852061.jpg" alt=""></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span>{
  <span class="hljs-attribute">justify-items</span>: end;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/57749032.jpg" alt=""></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: center;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/73568687.jpg" alt=""></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-items</span>: stretch;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/81147184.jpg" alt=""></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-11/31201904.jpg" alt=""></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: end;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/37389909.jpg" alt=""></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: center;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/64308393.jpg" alt="Example of align-items set to center"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-items</span>: stretch;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/33767654.jpg" alt="Example of align-items set to stretch"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-18/16621438.jpg" alt="Example of justify-content set to start"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: end; 
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/46252522.jpg" alt="Example of justify-content set to end"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: center;  
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/31369605.jpg" alt="Example of justify-content set to center"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: stretch; 
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-11/65452171.jpg" alt="Example of justify-content set to stretch"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: space-around;  
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/79036314.jpg" alt="Example of justify-content set to space-around"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: space-between; 
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/36148565.jpg" alt="Example of justify-content set to space-between"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">justify-content</span>: space-evenly;  
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/9095829.jpg" alt="Example of justify-content set to space-evenly"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/9095829.jpg" alt="Example of align-content set to start"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: end; 
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/15060507.jpg" alt="Example of align-content set to end"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: center;  
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/72396881.jpg" alt="Example of align-content set to center"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: stretch; 
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/46794685.jpg" alt="Example of align-content set to stretch"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: space-around;  
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/81192919.jpg" alt="Example of align-content set to space-around"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: space-between; 
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/27437729.jpg" alt="Example of align-content set to space-between"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.container</span> {
  <span class="hljs-attribute">align-content</span>: space-evenly;  
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/6825571.jpg" alt="Example of align-content set to space-evenly"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/90644000.jpg" alt="Example of 2 x 2 grid"></p>
<p>这里创建了一个 2x2的网格。</p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/38445302.jpg" alt="Example of implicit tracks"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/33573866.jpg" alt="Example of implicit tracks"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/92242678.jpg" alt="Example of grid-auto-flow set to row"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/55339887.jpg" alt="Example of grid-auto-flow set to column"></p>
<h3 id="grid">grid</h3>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/8301648.jpg" alt="Example of grid-row/column-start/end"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/35742447.jpg" alt="Example of grid-row/column-start/end"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/95036015.jpg" alt="Example of grid-column/grid-row"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/37070111.jpg" alt="Example of grid-area"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/53670315.jpg" alt="Example of justify-self set to start"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">justify-self</span>: end;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/15608697.jpg" alt="Example of justify-self set to end"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">justify-self</span>: center;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/42777942.jpg" alt="Example of justify-self set to center"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">justify-self</span>: stretch;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/42754838.jpg" alt="Example of justify-self set to stretch"></p>
...
<p><img src="//cloud.hunger-valley.com/18-1-12/67517511.jpg" alt="Example of align-self set to start"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">align-self</span>: end;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/9140938.jpg" alt="Example of align-self set to end"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
  <span class="hljs-attribute">align-self</span>: center;
}
</code></pre>
<p><img src="//cloud.hunger-valley.com/18-1-12/38240821.jpg" alt="Example of align-self set to center"></p>
<pre><code class="lang-css"><span class="hljs-selector-class">.item-a</span> {
